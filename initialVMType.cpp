...
const resource_unit vm_medium_cpu = 2;
const resource_unit vm_medium_mem = 0;
const resource_unit vm_medium_disk = 0;

//VM referred as LARGE
const resource_unit vm_large_cpu = 4;
const resource_unit vm_large_mem = 0;
const resource_unit vm_large_disk = 0;

//VM referred as XLARGE
const resource_unit vm_xlarge_cpu = 6;
const resource_unit vm_xlarge_mem = 0;
const resource_unit vm_xlarge_disk = 0;
